        ...
        <div class="mw-ui-box-content">
            <form action="<?php echo admin_url('mw_install_create_user') ?>" method="post" class="mw_install_create_user">
                ...
                <div style="text-align: center">
                    <!-- <img width="100%" src="<?php print mw()->ui->admin_logo_login(); ?>" alt="Logo" align="center"> -->
                    <img src="<?php print modules_url(); ?>cotiqu/assets/img/logo.png" class="logo svg logo2" align="center"/>
                </div>
